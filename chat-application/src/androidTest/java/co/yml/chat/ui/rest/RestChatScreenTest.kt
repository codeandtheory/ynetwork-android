...
import co.yml.network.android.engine.network.body.SEGMENT_SIZE
...
import co.yml.network.core.engine.network.demo.FileTransferProgressCallbackHelper
...
import co.yml.chat.ChatActivity
import co.yml.chat.UniqueIdGenerator
import co.yml.chat.actions.ui.rest.RestChatScreenActions
import co.yml.chat.assertions.ui.rest.RestChatScreenAssertions
...
class RestChatScreenTest {
    ...
    fun verifyMessageSendWithAttachment(): Unit = runBlocking {
        ...
        assertions.verifyAttachmentListItem(0, attachmentTitle, "Upload Completed")
